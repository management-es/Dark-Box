...
class CrearAgendaActivity : ComponentActivity() {
    ...
    private lateinit var buttonSolicitudInstalacion: Button // Nuevo botón
    private lateinit var buttonOtrasGestiones: Button // Nuevo botón
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonSolicitudInstalacion = findViewById(R.id.button_solicitud_instalacion) // Inicializa el botón
        buttonOtrasGestiones = findViewById(R.id.button_otras_gestiones) // Inicializa el botón
        ...
        dateInputLayout.visibility = View.VISIBLE // Haz visible el dateInputLayout al inicio
        buttonCrearAgenda.visibility = View.GONE  // Oculta el botón Crear Agenda al inicio
        ...
        // Cargar clientes cuando se inicia la actividad, si corresponde
        cargarClientes()
    }
    ...
    private fun cargarClientes() {
        ...
        database.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                // Manejar errores
                Toast.makeText(this@CrearAgendaActivity, "Error al cargar los clientes", Toast.LENGTH_SHORT).show()
            }
        })
    }

    private fun actualizarSpinner(clientes: List<String>) {
        val adapter = ArrayAdapter(this@CrearAgendaActivity, android.R.layout.simple_spinner_item, clientes)
    ...
    private fun mostrarNombreCliente(codCliente: String) {
        database.child(codCliente).addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@CrearAgendaActivity, "Error al obtener los datos del cliente", Toast.LENGTH_SHORT).show()
            }
        })
    }
