...
class FiltrarAgendaActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonAplicarFiltro.setOnClickListener {
            ...
            buscarAgendaEnFirebase(anioIngresado, mesSeleccionado, resultadosTextView)
        }
        ...
        for (i in 1..3) {
            ...
            // Agregar las celdas para cada fila (bajo cada columna)
    ...
    private fun buscarAgendaEnFirebase(anio: String, mes: String, resultadosTextView: TextView) {
            ...
            .addOnSuccessListener { snapshot ->
                if (snapshot.exists()) {
                    ...
                    for (child in snapshot.children) {
                        ...
                        // Obtener valores específicos del subnodo
                        ...
                        val estado = child.child("estado").getValue(String::class.java) ?: "Pendiente" // Cambiar N/A por "Pendiente"

                        // Formatear los resultados para mostrarlos en el TextView
                        resultados.append(
                            """
